"""
多平台发布脚本 - 2026/07/08 批次4 重发v2
跳过已成功的第1篇（华为Token第一篇），重发剩余12篇
"""
...
def main():
    ...
    # 跳过已成功的：原批次第1-3篇 + retry第1篇(=原第4篇) = 共4篇已发
    # 原始16篇，已发4篇，还剩12篇
    posts = all_posts[4:]
    ...
    logger.info("=" * 60)
    logger.info("📋 多平台发布 - 2026/07/08 批次4 重发v2（第5-16篇）")
    logger.info(f"   共 {len(posts)} 篇帖子，3平台")
